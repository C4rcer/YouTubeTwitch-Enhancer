...
(function (root, factory) {
    ...
    function integrationSummary(settings) {
        ...
        return [
            ...
            {
                id: 'sync', name: 'Firefox Sync', active: !!s.syncBlockLists,
                detail: 'When enabled, supported block lists are stored through your Firefox account.'
            }
        ];
    }
    ...
    async function boot(win) {
        ...
        dataSection.content.append(
            ...
            node('label', { class: 'toggle ytb-sync-toggle' }, [syncToggle, node('span', { class: 't-text' }, [
                node('b', {}, ['Firefox Sync for supported block lists ', node('span', { class: 'network-badge', text: 'Firefox Sync' })]),
        ...
        syncToggle.addEventListener('change', () => updateData((syncToggle.checked ? 'Enabled' : 'Disabled') + ' Firefox Sync', ['settings'], current => {
